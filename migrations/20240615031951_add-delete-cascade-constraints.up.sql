...
ALTER TABLE display_names ADD CONSTRAINT display_names_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(web_services_user_id) ON DELETE CASCADE;

ALTER TABLE falls DROP CONSTRAINT falls_user_id_fkey;
ALTER TABLE falls ADD CONSTRAINT falls_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(web_services_user_id) ON DELETE CASCADE;
